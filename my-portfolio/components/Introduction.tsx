  ...
  return (
    <>
      <div className={styles.introduction}>
        ...
        <p className={styles.introduction__text}>フロントエンドディベロッパー。<b>レスポンシブWebコーディング・CMS利用のWeb制作が経験豊富で、大規模サイトの制作・運用実績もある。</b>興味のある領域は、ユーザーインターフェース・Webアクセシビリティ。<a href="#education">工学・芸術の学士</a>。趣味は音楽（鑑賞・演奏・制作）など。</p>
      </div>
      {/* Profile end */}
    </>
  )
